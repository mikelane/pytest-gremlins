...
- **Mutation Switching** - All mutations are embedded in a single instrumentation pass, toggled via environment variable. No file I/O or module reloading per mutation.
...
This project follows a strict TDD discipline and uses BDD with Gherkin scenarios. All contributions must include tests written *before* implementation.
