...
- **Coverage map expansion**: bare function names from `dynamic_context=test_function` are now
  expanded to full node IDs at insertion time, eliminating 15.6% error rate on attrs (#365)
