...
class DescribeExtractTestNameFromContext:
    ...
    def it_new_format_run_phase_returns_function_name(self) -> None:
    ...
    def it_new_format_setup_phase_returns_function_name(self) -> None:
    ...
    def it_new_format_teardown_phase_returns_function_name(self) -> None:
    ...
    def it_new_format_with_class_returns_method_name(self) -> None:
    ...
    def it_different_function_name_produces_different_result(self) -> None:
    ...
    def it_old_format_double_colon_returns_last_segment(self) -> None:
