...
class DescribeSessionFinishWorkerGuard:
    ...
    def it_session_finish_skips_mutation_testing_on_xdist_worker(self) -> None:
    ...
    def it_session_finish_runs_mutation_testing_on_controller(self, tmp_path: Path) -> None:
...
class DescribeSessionFinishBranches:
    ...
    def it_session_finish_returns_early_when_no_gremlins(self, tmp_path: Path) -> None:
    ...
    def it_session_finish_calls_batch_testing_when_batch_enabled(self, tmp_path: Path) -> None:
    ...
    def it_session_finish_calls_parallel_testing_when_parallel_enabled(self, tmp_path: Path) -> None:
